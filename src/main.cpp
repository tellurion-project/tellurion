...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "2 Dec 2015";
        CTransaction txNew;
 
        txNew.nTime = 1449110000;
      ...
      txNew.vin.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1449110000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
 
        block.nNonce   = 9770142;
     ...
     uint256 hash = block.GetHash();
        ...
        assert(block.hashMerkleRoot == uint256("0x584ed5f5057eb0de5ef1d78433e1d2eb330b2fa8a6ffba44172b9bd443be7ad4"));
